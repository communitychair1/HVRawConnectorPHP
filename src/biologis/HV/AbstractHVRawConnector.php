 ...
 * @edited Nicholas Costello 7/18/2013
 */
...
abstract class AbstractHVRawConnector implements HVRawConnectorInterface
{
    ...
    /** Set Health Vault Platform
     * @param $healthVaultPlatform
     *      Returns the health vault platform
     */
    ...
    /** Get Authenticated WC Request Xml
     * @return string :
     *      Returns an XML template for getting authenticated Wc Requests to Microsoft Health Vault.
     *      location of template: /XmlTemplates/AuthenticatedWcRequestTemplate.xml
     */
    public function getAuthenticatedWcRequestXML()
    {
        return file_get_contents(__DIR__ . '/XmlTemplates/AuthenticatedWcRequestTemplate.xml');
    }

    /** Get Offline Request Xml
     * @return string :
     *      Returns an XML template for offline Wc Requests to Microsoft Health Vault.
     *      location of template: /XmlTemplates/OfflineRequestTemplate.xml
     */
    public function getOfflineRequestXML()
    {
        return file_get_contents(__DIR__ . '/XmlTemplates/OfflineRequestTemplate.xml');
    }

    /** Get Authenticated Session Token Template Xml
     * @return string :
     *      Returns an XML template for creating and authenticated session token to Microsoft Health Vault.
     *      location of template: /XmlTemplates/CreateAuthenticatedSessionTokenTemplate.xml
     */
    public function getAuthenticatedSessionTokenTemplateXml()
    {
        return file_get_contents(__DIR__ . '/XmlTemplates/CreateAuthenticatedSessionTokenTemplate.xml');
    }

    /** Get Get Anonymous Wc Request Template Xml
     * @return string :
     *      Returns an XML template for making an AnonymousWc Request to Microsoft Health Vault.
     *      location of template: /XmlTemplates/CreateAuthenticatedSessionTokenTemplate.xml
     */
    public function getAnonymousWcRequestTemplateXML()
    {
        return file_get_contents(__DIR__ . '/XmlTemplates/AnonymousWcRequestTemplate.xml');
    }
